      ...
      <div className="relative h-48 w-full overflow-hidden">
        ...
        <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm rounded-full 
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.218 3.932a1 1 0 001.516.577l4.254-2.366a1 1 0 00.524-1.57l-2.922-4.188a1 1 0 00-1.134-.894l-3.18 1.783a1 1 0 00-.976.588l-1.389-4.28a1 1 0 00-.365-1.39z"></path>
          </svg>
